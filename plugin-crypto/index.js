const Affine = require('./algorithms/affine')
const Vigenere = require('./algorithms/vigenere')
const TwoSquare = require('./algorithms/two-square')
const FourSquare = require('./algorithms/four-square')
const { CQCode } = require('koishi-utils')

module.exports.name = 'crypto'
